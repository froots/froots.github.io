...
This is the first in a series of articles demonstrating how to test a [Backbone.js](http://backbonejs.org/) application, employing the [Jasmine BDD](https://jasmine.github.io/) test framework and the [Sinon.JS](http://sinonjs.org/) spying, stubbing and mocking library.
